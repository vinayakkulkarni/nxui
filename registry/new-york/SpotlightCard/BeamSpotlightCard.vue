...
<template>
  ...
  >
    <div class="absolute pointer-events-none transition-all duration-150" :style="verticalBeamStyle" />
    <div class="absolute pointer-events-none transition-all duration-150" :style="horizontalBeamStyle" />
    <div class="absolute pointer-events-none transition-all duration-150" :style="intersectionStyle" />
