...
<template>
  <div class="relative mt-4">
    <div :class="['relative h-12 rounded-full overflow-hidden border', trackClass]">
      <component
        :is="motion.div"
      ...
      >
        ...
        >
          <svg class="size-5 text-white rotate-45" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <component
      ...
      :class="['absolute right-4 top-1/2 -translate-y-1/2 text-sm font-mono font-medium', timeClass]"
    >
      {{ remainingTime }}
    </component>
  </div>
