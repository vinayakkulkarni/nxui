---
title: Voronoi
description: Voronoi cell diagram with configurable colors, glow, gap width, and organic distortion. Ported from Paper Shaders (Apache-2.0).
---
...
```bash
npx shadcn-vue@latest add "https://nxui.geoql.in/r/paper-voronoi.json"
```
...
| ----------------- | -------------------------------- | ------------------------ | -------------------------------------------------- |
| `colors`          | `string[]`                       | `['#ff8247', '#ffe53d']` | Up to 5 colors used for cells and gradients        |
| `steps-per-color` | `number`                         | `3`                      | Step granularity within each color band (1 to 10)  |
| `color-glow`      | `string`                         | `'#ffffff'`              | Glow color blending into cell edges                |
| `color-gap`       | `string`                         | `'#2e0000'`              | Color of the gaps between cells                    |
| `distortion`      | `number`                         | `0.4`                    | Strength of organic distortion (0 to 1)            |
| `gap`             | `number`                         | `0.04`                   | Width of the gap between cells (0 to 0.1)          |
| `glow`            | `number`                         | `0`                      | Strength of the glow between cells (0 to 1)        |
...
| `scale`           | `number`                         | `0.5`                    | Overall zoom level (0.01 to 4)                     |
