...
<template>
  <NuxtLink
    ...
    target="_blank"
    class="group relative inline-flex h-9 items-center gap-2 rounded-xl border border-yellow-500/10 bg-yellow-500/3 px-3 text-sm text-muted-foreground backdrop-blur-sm transition-all duration-200 hover:border-yellow-500/20 hover:bg-yellow-500/8 hover:text-foreground hover:shadow-[0_0_20px_rgba(234,179,8,0.08)]"
  >
    <div class="flex items-center gap-2">
      <Icon
        name="lucide:star"
        class="size-4 text-yellow-500 transition-transform duration-300 group-hover:rotate-15 group-hover:scale-110"
      />
