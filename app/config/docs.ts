...
export const docsNav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { title: 'ASCII Text', path: '/docs/text-animations/ascii-text', badge: 'New' },
      ...
      { title: 'Falling Text', path: '/docs/text-animations/falling-text', badge: 'New' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Dome Gallery', path: '/docs/components/dome-gallery', badge: 'New' },
      {
      ...
      { title: 'Fluid Glass', path: '/docs/components/fluid-glass', badge: 'New' },
      ...
      { title: 'Infinite Menu', path: '/docs/components/infinite-menu', badge: 'New' },
      { title: 'Lanyard', path: '/docs/components/lanyard', badge: 'New' },
      ...
      { title: 'Model Viewer', path: '/docs/components/model-viewer', badge: 'New' },
      { title: 'Node Diagram', path: '/docs/components/node-diagram' },
      { title: 'Orbit Images', path: '/docs/components/orbit-images', badge: 'New' },
      { title: 'Pill Nav', path: '/docs/components/pill-nav', badge: 'New' },
      ...
      { title: 'Scroll Stack', path: '/docs/components/scroll-stack', badge: 'New' },
      ...
      { title: 'Staggered Menu', path: '/docs/components/staggered-menu', badge: 'New' },
      { title: 'Stepper', path: '/docs/components/stepper' },
      { title: 'Sticker Peel', path: '/docs/components/sticker-peel', badge: 'New' },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Splash Cursor', path: '/docs/animations/splash-cursor', badge: 'New' },
      { title: 'Star Border', path: '/docs/animations/star-border' },
      { title: 'Target Cursor', path: '/docs/animations/target-cursor', badge: 'New' },
    ],
  },
  {
    title: 'Backgrounds',
    items: [
      { title: 'Antigravity', path: '/docs/backgrounds/antigravity', badge: 'New' },
      ...
      { title: 'Galaxy', path: '/docs/backgrounds/galaxy', badge: 'New' },
      ...
      { title: 'Grid Scan', path: '/docs/backgrounds/grid-scan', badge: 'New' },
      { title: 'Hyperspeed', path: '/docs/backgrounds/hyperspeed', badge: 'New' },
      { title: 'Iridescence', path: '/docs/backgrounds/iridescence' },
      { title: 'Laser Flow', path: '/docs/backgrounds/laser-flow', badge: 'New' },
      {
        title: 'Letter Glitch',
      ...
      { title: 'Metallic Paint', path: '/docs/backgrounds/metallic-paint', badge: 'New' },
      {
        title: 'Liquid Chrome',
      ...
      { title: 'Particles', path: '/docs/backgrounds/particles', badge: 'New' },
